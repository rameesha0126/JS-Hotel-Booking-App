# MERN Booking App (JS Version)

This is a Hotel Booking App made with MERN Stack to run on the local machine.
...
```bash
git clone https://github.com/rameesha0126/JS-Hotel-Booking-App.git
cd mern-booking-app
```
...
5. **VITE_API_BASE_URLL**:
    - The `BASE_URL` should point to the URL where your backend application is running (typically `http://localhost:7000` if you're running it locally).
...
# Testing section not included in this project
